    ...
    <div
      ...
      className={
        isGridView
          ...
          : "border rounded-xl shadow-md flex items-center justify-center gap-4 p-4cursor-pointer hover:scale-105 hover:shadow-lg transition-all duration-500"
      }
    >
      <Image
        src={flag}
        ...
        className={isGridView ? "object-cover w-32 h-24 mt-2" : "object-cover w-auto h-36 rounded-md"}
      />
